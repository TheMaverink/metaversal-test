...
export default function ProfileCardSmall({ user }) {
  const { firstName, lastName, username, address, posts, company, totalLikes } =
    user;

  return (
    <div
      className={`w-full relative flex flex-col gap-[24px] justify-between border border-[#E4E7E8] shadow-[0px_1px_0px_rgba(26,26,26,0.08)]`}
      style={{
        borderRadius: '12px',
    ...
    >
      ...
      <div className="profile-card-body-details-top flex flex-col gap-[8px] items-center pt-[24px]">
      ...
      <div className="profile-card-body-details-bottom flex gap-[24px] items-center justify-center">
      ...
      <div
        className="profile-card-body-footer w-full p-4 flex gap-[16px] h-[68px] justify-center"
        style={{
